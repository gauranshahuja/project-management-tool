...
// Fail-safe email sender. If SMTP env vars are not set, it logs to console
// in dev mode instead of throwing, so the app works without email configured.
//
// Configure via .env:
// SMTP_HOST, SMTP_PORT, SMTP_USER, SMTP_PASS, EMAIL_FROM
// Example providers: Gmail app-password, Mailtrap, SendGrid SMTP.
...
// sendEmail({ to, subject, html, text }) never throws.
